...
namespace Lab1B.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> SeedRoles()
        {
            ...
            {
                Email = "rose@james.com",
                UserName = "rose@james.com",
                PhoneNumber = "222-222-2222",
                Company="e",
                BirthDate = new DateTime(2000, 06, 10)
            };
            ApplicationUser user2 = new ApplicationUser
            {
                Email = "sb@james.com",
                UserName = "sb@james.com",
                PhoneNumber = "000-222-2222",
                Company = "ee",
                BirthDate = new DateTime(2000, 06, 15)

            };
            IdentityResult result = await _userManager.CreateAsync(user1, "P@ssword1");
            if (!result.Succeeded)
                return View("Error", new ErrorViewModel { RequestId = "Failed" });
